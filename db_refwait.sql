...
CREATE TABLE `rw_merchant` (
  ...
  `price_of_avg` decimal(6,2) NOT NULL default '10.00' COMMENT '人均消费',
  `star_value` int(1) unsigned NOT NULL default '3' COMMENT '星值，1~5',
  `is_qualified` tinyint(1) unsigned NOT NULL default '2' COMMENT '是否合格(0:不合格,1:合格,2:审核中)',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='商家表';

-- ----------------------------
-- Records of rw_merchant
-- ----------------------------
INSERT INTO `rw_merchant` VALUES ('1', 'mlxg9349326871', '拿渡麻辣香锅(华发商都店)', '123456789', '123456789', '广东省珠海市香洲区珠海大道8号华发商都1号楼三楼A3043B-A3045号', '113.51000', '22.22000', '0', 'unset', 'http://120.78.182.217/images/1514274868158.jpg', '10.00', '3', '1', '2017-12-26 15:54:28', '2017-12-26 15:54:28');
INSERT INTO `rw_merchant` VALUES ('2', 'mlxg9349326872', '不夜天柴火烤鱼火锅店', 'unset', '123456789', '广东省珠海市金湾区红旗中珠花园(广安路南)', '113.35000', '22.14000', '0', 'unset', 'http://120.78.182.217/images/1514274903549.jpg', '10.00', '4', '1', '2017-12-26 15:55:03', '2017-12-26 15:55:03');
INSERT INTO `rw_merchant` VALUES ('3', '9349326873', '雅高西餐厅', 'unset', '123456789', '广东省珠海市金湾区广安路121号附近', '113.35116', '22.13579', '0', 'unset', 'http://120.78.182.217/images/1514275044819.jpg', '10.00', '5', '1', '2017-12-26 15:57:25', '2017-12-26 15:57:25');
INSERT INTO `rw_merchant` VALUES ('4', 'aaaa9349326874', '沙县小吃', '1234567894', '1234567894', '广东省珠海市斗门区白藤三路西江月六号商铺(湖湘人家旁)', '113.35772', '22.15370', '0', 'unset', 'http://120.78.182.217/images/1514275097303.jpg', '10.00', '5', '1', '2017-12-26 15:58:17', '2017-12-26 15:58:17');
INSERT INTO `rw_merchant` VALUES ('5', 'aaaa9349326875', '岳阳烧烤', '1234567895', '1234567895', '广东省珠海市金湾区广安路中珠花园3号铺', '113.34804', '22.13623', '0', 'unset', 'http://120.78.182.217/images/1514275209749.jpg', '10.00', '5', '1', '2017-12-26 16:00:09', '2017-12-26 16:00:09');
INSERT INTO `rw_merchant` VALUES ('6', 'aaaa9349326876', '尖峰煲仔饭', '1234567896', '1234567896', '广东省珠海市斗门区尖峰前路247号附近(武商量贩港澳店斜对面)', '113.30584', '22.19333', '0', 'unset', 'http://120.78.182.217/images/1514275269282.jpg', '10.00', '4', '1', '2017-12-26 16:01:09', '2017-12-26 16:01:09');
INSERT INTO `rw_merchant` VALUES ('7', 'aaaa9349326877', '炭舍烤鱼(珠海乐世界购物中心店)', '1234567897', '1234567897', '广东省珠海市香洲区明珠北路338号珠海乐世界购物中心内', '113.50924', '22.27519', '0', 'unset', 'http://120.78.182.217/images/1514275337034.jpg', '10.00', '3', '1', '2017-12-26 16:02:17', '2017-12-26 16:02:17');
INSERT INTO `rw_merchant` VALUES ('8', 'aaaa9349326878', '马得利(吉大店)', '1234567898', '1234567898', '广东省珠海市香洲区吉大景山路222号珠海百货广场首层', '113.57970', '22.25601', '0', 'unset', 'http://120.78.182.217/images/1514275361351.jpg', '10.00', '4', '1', '2017-12-26 16:02:41', '2017-12-26 16:02:41');
